...
class SearchDataProvider implements DataProviderInterface
{
    ...
    public function getItems()
    {
        ...
        $this->_totalCount = $this->getTotalProductsCount($query);
        ...
        $result['total_count'] = $this->getTotalCount($query);
        return $result;
    }
    ...
    public function getTotalProductsCount($query)
    {
        ...
        $searchCriteria->setFilterGroups([ $filterGroup ])
            ->setCurrentPage($currentPage);
        $searchResults = $this->fullTextSearchApi->search($searchCriteria);
        $searchResultsItems = $searchResults->getItems();
        return count($searchResultsItems);
    }
}