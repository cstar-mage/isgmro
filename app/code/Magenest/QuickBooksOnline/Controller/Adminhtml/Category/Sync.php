        ...
        try {
            ...
            foreach ($collections as $collection) {
                ...
                try {
                    ...
                    $this->messageManager->addErrorMessage('Can\'t sync Category Name:' . $collection->getName());
                    continue;
                }
                if (!$update) {
                    $this->messageManager->addSuccessMessage(__('A total of %1 categories have been synchronize to QuickBooksOnline.', $totals));
                } else {
                    $this->messageManager->addSuccessMessage(__('A total of %1 categories have been update to QuickBooksOnline.', $totals));
                }
            }
        } catch (\Exception $e) {
